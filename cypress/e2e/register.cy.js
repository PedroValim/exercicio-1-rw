describe('Registro de Usuário', () => {
  ...
  it('Registro de novo usuário com sucesso', function () {
    cy.get('[data-test="signup-first-name"]')
      .type(this.userData.newUser.firstName);

    cy.get('[data-test="signup-last-name"]')
      .type(this.userData.newUser.lastName);

    cy.get('[data-test="signup-username"]')
      .type(this.userData.newUser.username);

    cy.get('[data-test="signup-password"]')
      .type(this.userData.newUser.password);

    cy.get('[data-test="signup-confirmPassword"]')
      .type(this.userData.newUser.confirmPassword);
